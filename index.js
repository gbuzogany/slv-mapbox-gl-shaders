...
module.exports = {
  ...
  custom: {
    fragmentSource: fs.readFileSync(path.join(__dirname, 'src/custom.fragment.glsl'), 'utf8'),
    vertexSource: fs.readFileSync(path.join(__dirname, 'src/custom.vertex.glsl'), 'utf8')
  }
};
